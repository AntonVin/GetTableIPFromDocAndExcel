...
namespace IpLibrary
{
    public class NetAddress
    {
        ...
        public NetAddress(string addressIp)
        {
            ...
            this.Ip &= GetMaskFromPrefix(this.Prefix);//округляем ip по маске
        }
        ...
        private uint GetMaskFromPrefix(int prefix)
        {
            var mask = this.Prefix == 0 ?
                            0 : 0b11111111_11111111_11111111_11111111u << (32 - prefix);
            return mask;
        }
